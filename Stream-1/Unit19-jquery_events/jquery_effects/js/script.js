...
$(document).ready(function(){
    ...
    //applys colour red to paragraphs when clicked on 
    $("p").click(function(){
     ...
     $("#hr_mysql").hover(function(){
      ...
      $("#hr_python").hover(function(){
       ...
       $("#hr_jquery").hover(function(){
        ...
        //applys colour black to body body background when mouse  over buttons
         $(".bottom_button").mouseenter(function(){
            $("body").css( "background-color", "black"); 

    });
        //applys colour grey to bodybackground wneh mouse leaves buttons
